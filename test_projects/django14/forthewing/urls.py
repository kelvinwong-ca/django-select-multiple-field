...
urlpatterns = patterns('',  # NOQA
    ...
    # url(r'^detail/(?P<pk>[0-9]*)$', ChickenWingsDetailView.as_view(), name='detail'),
    # url(r'^update/(?P<pk>[0-9]*)$', ChickenWingsUpdateView.as_view(), name='update'),
    # url(r'^updated/$', TemplateView.as_view(
    #     template_name='forthewing/chickenwings_updated.html'), name='updated'),
    # url(r'^delete/(?P<pk>[0-9]*)$', ChickenWingsDeleteView.as_view(), name='delete'),
